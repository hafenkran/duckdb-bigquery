...
| `bq_auth_timeout_ms`                      | Timeout for authentication token fetches in milliseconds. This bounds ADC metadata and OAuth token requests without changing normal BigQuery query timeouts. Effective granularity is seconds, rounded up. | `10000` |
