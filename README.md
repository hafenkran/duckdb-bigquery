...
| `pageToken`       | `VARCHAR` | Specifies a page token to return the next set of jobs from a previous request.                                          |
| `stateFilter`     | `VARCHAR` | Filters jobs by state (e.g., `RUNNING`, `DONE`).                                                                        |
