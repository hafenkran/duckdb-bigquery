...
google::cloud::Options BigqueryClient::OptionsAPI() {
    ...
    if (!ca_path.empty()) {
        options.set<google::cloud::v2_34::CARootsFilePathOption>(ca_path);
    }
    return options;
}
...
vector<google::cloud::bigquery::v2::ListFormatJob> BigqueryClient::ListJobs(const ListJobsParams &params) {
    ...
    google::cloud::v2_34::StreamRange<google::cloud::bigquery::v2::ListFormatJob> response = client.ListJobs(request);
